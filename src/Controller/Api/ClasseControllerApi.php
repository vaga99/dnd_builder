...
final class ClasseControllerApi extends AbstractController
{
    /**
     * Return all Classe in json format
     */
    #[Route('/api/classes', name: 'getClassesApi', methods: ['GET'])]
     ...
     */
    #[Route('/api/classes/{id}', name: 'getClasseApi', methods: ['GET'])]
     ...
     * Delete Classe
     */
    #[Route('/api/classes/{id}', name: 'deleteClasseApi', methods: ['DELETE'])]
    #[IsGranted('ROLE_DM', message: 'you\'re not allowed to delete a Classe')]
     ...
     * Add Classe
     */
    #[Route('/api/classes', name: 'createClasseApi', methods: ['POST'])]
     ...
     * Edit Classe
     */
    #[Route('/api/classes/{id}', name: 'editClasseApi', methods: ['PUT'])]
